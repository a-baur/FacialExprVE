...
{
    public class NetworkSRanipalEye : MonoBehaviour
    {
        ...
        {
            Dictionary<EyeShape_v2, float> eyeWeightings = EnumEyeWeightings(binEyeWeightings);
        ...
        /// </returns>
        private Dictionary<byte, float> BinaryEyeWeightings(Dictionary<EyeShape_v2, float> eyeWeightings)
        {
            Dictionary<byte, float> binEyeWeightings = new Dictionary<byte, float>();

            foreach (KeyValuePair<EyeShape_v2, float> eyeWeight in eyeWeightings)
            {
        ...
        /// </returns>
        private Dictionary<EyeShape_v2, float> EnumEyeWeightings(Dictionary<byte, float> binEyeWeightings)
        {
            Dictionary<EyeShape_v2, float> eyeWeightings = new Dictionary<EyeShape_v2, float>();

            foreach (KeyValuePair<byte, float> eyeWeight in binEyeWeightings)
            {
                eyeWeightings[(EyeShape_v2)eyeWeight.Key] = eyeWeight.Value;
            }
